...
export const features = [
  ...
  { name: 'meetups', label: '모임', title: '모임', order: 10, icon: CalendarDays, component: MeetupPage },
  ...
  { name: 'badges', label: '뱃지', title: 'AI 뱃지', memberOnly: true, order: 105, icon: Award, component: BadgesPage },
