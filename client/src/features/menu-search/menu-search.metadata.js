export const menuSearchMetadata = [
  ...
  {
    featureName: 'admin',
    description: '멤버의 관리자 권한과 비밀번호 재설정을 관리하고, 소모임 앱에 모임 만들기를 자동으로 요청합니다.',
    searchTerms: ['관리자 권한', '관리자 임명', '권한 해제', '비밀번호 초기화', '멤버 관리', '소모임 자동화', '소모임 모임 만들기'],
    examples: ['관리자를 새로 지정하고 싶어', '멤버 비밀번호를 초기화하고 싶어', '소모임에 모임을 자동으로 만들고 싶어'],
  },
  {
